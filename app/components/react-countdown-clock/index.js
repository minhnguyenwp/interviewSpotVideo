! function(t, e) {
    ...
    return function(t) {
        ...
        }, n.p = "/Users/hugh/Downloads/react-countdown-clock/build", n(n.s = 10)
    }([function(t, e, n) {
        "use strict";
        var i = function(t) {};
        ...
        r = n(1), i = n(9), (s = n(5)({
            ...
            _tick: function() {
                var t, e = this;
                return t = Date.now(), this._timeoutIds.push(setTimeout(function() {
                    var n;
                    return n = (Date.now() - t) / 1e3, e._seconds -= n, e._seconds <= 0 ? (e._seconds = 0, e._handleComplete(), e._clearTimer()) : (e._updateCanvas(), e._tick())
                }, this._tickPeriod))
            },
            ...
            _drawTimer: function() {
                ...
                return e = this._fraction * this._seconds + 1.5, 
                	...
                	this._timer.arc(this._radius, this._radius, this._radius, 1.5 * Math.PI, Math.PI * e, !1), 
                	this._timer.arc(this._radius, this._radius, this._innerRadius, Math.PI * e, 1.5 * Math.PI, !0), 
                	this._timer.closePath(),
                	this._timer.fill(),

                	n = this.props.paused && null != this.props.pausedText ? this.props.pausedText : t, this._timer.globalAlpha = this.props.alpha, 
                	this.props.fontColor ? this._timer.fillStyle = this.props.fontColor : this._timer.fillStyle = this.props.color, 
                	this._timer.font = "bold " + this._fontSize(t) + " " + this.props.font, 
                	this._timer.fillText(n, this._radius, this._radius)
